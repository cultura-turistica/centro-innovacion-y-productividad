            ...
            <div style={{ padding: '2rem clamp(1rem, 3vw, 3rem)' }}>
              ...
              <div style={{ background: 'white', borderRadius: '25px', padding: '3rem 2rem', border: '1px solid #e2e8f0', boxShadow: '0 20px 40px rgba(0,0,0,0.04)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '2rem' }}>
                  ...
                  <div>
                    <h3 style={{ color: '#0f172a', margin: '0', fontSize: '1.5rem', fontWeight: 900 }}>{data.simulador.title}</h3>
                    <p style={{ color: '#475569', margin: '5px 0 0 0', fontSize: '1rem' }}>{data.simulador.subtitle}</p>
                  </div>
                </div>

                <div style={{ background: '#f8fafc', padding: '2rem', borderRadius: '15px', borderLeft: '5px solid #032968', marginBottom: '2.5rem' }}>
                  <p style={{ fontSize: '1.1rem', color: '#334155', lineHeight: '1.7', margin: 0 }} dangerouslySetInnerHTML={{ __html: data.simulador.intro }}></p>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', background: 'white', padding: '2rem', borderRadius: '20px', border: '2px solid #e2e8f0' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: '1rem', borderBottom: '2px dashed #cbd5e1' }}>
                    <h4 style={{ margin: 0, fontSize: '1.3rem', color: '#0f172a' }}>{data.simulador.fundsLabel}</h4>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <strong style={{ color: '#0f172a', display: 'flex', alignItems: 'center', gap: '8px' }}><ShieldAlert size={18} color="#032968" /> {data.simulador.categories[0].label}</strong>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <strong style={{ color: '#0f172a', display: 'flex', alignItems: 'center', gap: '8px' }}><Users size={18} color="#b45309" /> {data.simulador.categories[1].label}</strong>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <strong style={{ color: '#0f172a', display: 'flex', alignItems: 'center', gap: '8px' }}><Target size={18} color="#059669" /> {data.simulador.categories[2].label}</strong>
                  ...
                  {budgetResult && (
                    <div className="pop-in" style={{ padding: '2rem', borderRadius: '15px', border: `2px solid ${budgetResult.success ? '#16a34a' : '#ef4444'}`, background: budgetResult.success ? '#f0fdf4' : '#fef2f2', display: 'flex', gap: '20px', alignItems: 'center' }}>
                      ...
                      <div>
                        <h4 style={{ color: budgetResult.success ? '#166534' : '#b91c1c', fontSize: '1.3rem', margin: '0 0 10px 0' }}>{budgetResult.success ? data.simulador.alerts.successTitle : data.simulador.alerts.errorTitle}</h4>
