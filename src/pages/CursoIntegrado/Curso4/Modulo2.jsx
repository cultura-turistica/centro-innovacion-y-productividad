...
import img_0 from '../../../assets/fotografia/smartphone_tripod_1777058924777.webp';
import img_1 from '../../../assets/fotografia/macro_phone_lens_1777061014302.webp';
        ...
        <div style={{ background: '#1E293B', color: 'white', borderRadius: '30px', padding: '3rem', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
            <div style={{ background: 'rgba(255,255,255,0.05)', padding: 0, borderRadius: '20px', overflow: 'hidden' }}>
              <img src={img_0} alt="Trípode Pequeño Celular" style={{width: "100%", height: "150px", objectFit: "cover"}} />
            ...
            <div style={{ background: 'rgba(255,255,255,0.05)', padding: 0, borderRadius: '20px', overflow: 'hidden' }}>
              <img src={img_1} alt="Lente Macro para Celular" style={{width: "100%", height: "150px", objectFit: "cover"}} />
              <div style={{padding: '2rem'}}>
