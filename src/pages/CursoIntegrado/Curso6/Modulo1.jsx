...
export default function Modulo1({ step, headerColor, headerGradient }) {
      ...
      {step === 1 && (
        <div style={{ padding: '2rem clamp(1rem, 3vw, 3rem)' }}>
          <PodcastPlayer
            ...
            subtitle="Módulo 1"
            audioSrc="/audio/C6-M1.wav"
            transcript={<p>Bienvenidos a la Arquitectura de Experiencias Privadas. En el diseño moderno de turismo, nuestro objetivo ya no es simplemente ofrecer un servicio o una habitación limpia; eso es lo mínimo. Nuestro verdadero objetivo es construir puentes hacia las necesidades reales y ocultas de nuestros usuarios. Acompáñanos a descubrir cómo la empatía, y el entender verdaderamente los dolores y anhelos de tu cliente ideal, puede transformar un simple espacio en una memoria inolvidable. Olvídate de los segmentos amplios, es hora de diseñar basados en personas reales.</p>}
            color={headerColor}
          />
        </div>
      )}
