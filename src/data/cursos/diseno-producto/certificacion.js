export const certificacionData = {
  ...
  title: "Certificación: Diseño de Producto",
  description: "Demuestra tus conocimientos en diseño de producto turístico y obtén tu certificado oficial.",
  completionTitle: "¡Estás a un paso!",
  completionDesc: "Supera el 80% en la prueba final para generar tu certificado validado criptográficamente.",
  certBtn: "Presentar Prueba Final",
  ...
  encuesta: {
    ...
    questions: [
      ...
      {
        id: "q2",
        question: "¿La plataforma fue fácil de usar?",
