      ...
      <div className="relative z-10">
        ...
        <main className="max-w-7xl mx-auto px-6 pt-32 pb-24 space-y-16">
          ...
          <nav className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 mb-2">
            ...
            <Link href="/academia" className="hover:text-indigo-500 transition-colors">Academia</Link>
            <ChevronRight className="w-3 h-3" />
            <Link href="/academia/cursos/fotografia" className="hover:text-indigo-500 transition-colors">Curso de Fotografía</Link>
            <ChevronRight className="w-3 h-3" />
            <span className="text-indigo-500">Evaluación Final</span>
          </nav>

          {/* Cabecera */}
          <section>
            <div className="bg-indigo-900 rounded-[2.5rem] p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="relative z-10 text-left max-w-2xl">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-800/50 text-indigo-300 font-bold text-xs tracking-widest uppercase mb-6 border border-indigo-700">
              ...
              <div className="relative z-10 bg-white/10 p-8 rounded-3xl backdrop-blur-sm border border-white/20 w-full md:w-auto text-center flex-shrink-0">
                 ...
                 <p className="text-indigo-100 mb-8 max-w-sm mx-auto">{certificacionData.completionDesc}</p>
                 
                 <div className="flex flex-col gap-4">
                    {!startEvaluation && (
                      <button 
                        onClick={() => setStartEvaluation(true)}
                        className="inline-block bg-amber-400 text-indigo-950 px-8 py-4 rounded-full font-black text-lg hover:bg-amber-300 transition-all hover:scale-105 shadow-[0_0_20px_rgba(251,191,36,0.4)]"
                      >
