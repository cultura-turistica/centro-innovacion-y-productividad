...
import { certificacionData } from '../../../../../data/cursos/curso-1/certificacion';
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-7xl mx-auto px-6 pt-32 pb-24 space-y-16">
          ...
          <nav className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 mb-2">
            ...
            <ChevronRight className="w-3 h-3" />
            <Link href="/academia/cursos/turismo-comunitario" className="hover:text-emerald-500 transition-colors">Curso Turismo Comunitario</Link>
            <ChevronRight className="w-3 h-3" />
